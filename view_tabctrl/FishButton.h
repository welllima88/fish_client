/********************************************************************
	CREATED:	2006/01/10
	CREATED:	10:1:2006   10:02
	FILENAME: 	FishButton.h
	WRITER:		CFishButton
	
	PURPOSE:
    REFER:
        http://www.codeproject.com/buttonctrl/cbuttonst.asp     -   Original Name BC Button
        메뉴 연동기능 지원 BCMenu 클래스 찾아서 붙여볼 것
    HISTORY:    
        2006/01/10 : CREATED BY CFishButton
*********************************************************************/
...
class CFishButton : public CButton
{
public:
    CFishButton();
	~CFishButton();
