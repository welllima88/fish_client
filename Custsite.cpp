												  ...
												  LRESULT * plResult)
{
	...
	FishMessageBox((CString)lpstrText, _T("Custom Browser"), /*dwType*/MB_ICONERROR);
...
//	return S_OK; // Do not show context menus
    return S_FALSE; // We've shown our own context menu. MSHTML.DLL will no longer try to show its own.
}
...
{
	// return the Dispatch we have for extending the object Model
