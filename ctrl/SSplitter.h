...
#define DEFAULT_SPLIITERWIDTH			6
...
public:
    enum {
        FISH_SPLITTER_BG_COLOR  =   RGB(0xF8, 0xF8, 0xF8),
        FISH_SPLITTER_LINE_COLOR  =   RGB(0xD3, 0xD7, 0xDD),
    };
...
public:
	...
	BOOL Create(DWORD dwStyle, 
			...
			UINT nFConstr = 30,
			UINT nSConstr = 30,
			UINT nSplitterWidth = DEFAULT_SPLIITERWIDTH
		);
	...
	void SetHideType(int nType = 0);		// 0 : top & left hide, 1 : bottom & right hide
