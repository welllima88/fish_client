...
/////////////////////////////////////////////////////////////////////////////
// CMultiSelectableTreeCtrl window
...
class MST_AFX_EXT_CLASS CMultiSelectableTreeCtrl : public CTreeCtrl
{
	DECLARE_DYNAMIC(CMultiSelectableTreeCtrl)
// Construction
public:
...
// Overrides
	...
	//{{AFX_VIRTUAL(CMultiSelectableTreeCtrl)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CMultiSelectableTreeCtrl();

	// Generated message map functions
protected:
	//{{AFX_MSG(CMultiSelectableTreeCtrl)
	afx_msg void OnLButtonDown(UINT nFlags, CPoint point);
	afx_msg void OnSetFocus(CWnd* pOldWnd);
	afx_msg void OnKillFocus(CWnd* pNewWnd);
	afx_msg void OnRButtonDown(UINT nFlags, CPoint point);
	afx_msg BOOL OhTreeItemExpanding(NMHDR* pNMHDR, LRESULT* pResult);
