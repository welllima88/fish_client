...
#ifndef CFishGeneralButton_h
#define CFishGeneralButton_h
...
class CFishGeneralButton : public CButton
{
/////////////////////////////////////////////////////////////////////////////
// Construction
public:
...
public:
  ...
  CFishGeneralButton::Type getType()
    { return m_type; }
  ...
  CFishGeneralButton::Text getTextStyle()
    { return m_textStyle; }
  ...
  CFishGeneralButton::Focus getFocusStyle()
    { return m_focusStyle; }
...
public:
	...
	//{{AFX_VIRTUAL(CFishGeneralButton)
	public:
...
protected:
  ...
  //! Button type.
  CFishGeneralButton::Type m_type;

  //! Text style.
  CFishGeneralButton::Text m_textStyle;

  //! Focus style.
  CFishGeneralButton::Focus m_focusStyle;
  ...
  // Number of CFishGeneralButton instances.
  static int m_nRefs;
